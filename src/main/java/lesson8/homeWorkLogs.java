...
public class homeWorkLogs {
    ...
    public static String randomDate (@RequestBody String jsonDate){
        ...
        String result = "{\"randomDate\":\"" + randomDate + "\"}";
        LoggerService.writeLog("Метод /randomDate", result);
        return result;
    }
    ...
    public static String sortedNumbers (@RequestBody String numbers, @RequestParam boolean isAsc){
        ...
        LoggerService.writeLog("Метод /numbers", result);
        return result;
    }
    ...
    public static String charJson (@RequestBody String jsonText) {
        ...
        String result = sb.toString();
        LoggerService.writeLog("Метод /text", result);
        return result;
    }
    ...
    public static String sum(@RequestBody String jsonSum){
        ...
        String result = "{\"sum\": " + res + "}";
        LoggerService.writeLog("Метод /sum", result);
        return result;
    }
    ...
    public static String sumif(@RequestBody String jsonSum_2){
        ...
        String result = "{\"sum_2\": " + res + "}";
        LoggerService.writeLog("Метод /sumif", result);
        return result;
    }
}
